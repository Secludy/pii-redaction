...
class FakePIIGenerator:
    ...
    def get_supported_categories():
        ...
        return [
            "age", "credit_card_info", "nationality", "date", "date_of_birth",
            "domain_name", "email_address", "demographic_group", "gender",
            "personal_id", "other_id", "banking_number", "medical_condition",
            "organization_name", "person_name", "phone_number", "street_address",
            "password", "secure_credential", "religious_affiliation"
        ]
    ...
    def _generate_medical_condition(self, original: str) -> str:
        ...
        conditions = [
            "Common Cold", "Seasonal Allergies", "Migraine", 
            "Minor Sprain", "General Checkup"
        ]
